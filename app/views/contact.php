    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-people-row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <h2 class="tm-text-primary mb-4">Mrityunjay Roy</h2>
                <h3 class="tm-text-secondary h5 mb-4">Website Design and Maintainance</h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <h2 class="tm-text-primary mb-4">Shyamal Malhotra</h2>
                <h3 class="tm-text-secondary h5 mb-4">Database Manager</h3>
                <ul class="tm-social pl-0 mb-0">
                    <li><a href="https://facebook.com"><i class="fab fa-facebook"></i></a></li>
                    <li><a href="https://twitter.com"><i class="fab fa-twitter"></i></a></li>
                    <li><a href="https://linkedin.com"><i class="fab fa-linkedin"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <h2 class="tm-text-primary mb-4">Saksham Thakur</h2>
                <h3 class="tm-text-secondary h5 mb-4">Website Designer (HTML, CSS )</h3>
                <ul class="tm-social pl-0 mb-0">
                    <li><a href="https://facebook.com"><i class="fab fa-facebook"></i></a></li>
                    <li><a href="https://twitter.com"><i class="fab fa-twitter"></i></a></li>
                    <li><a href="https://linkedin.com"><i class="fab fa-linkedin"></i></a></li>
